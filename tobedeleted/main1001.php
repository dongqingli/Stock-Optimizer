            ...
            <table class="table-condensed">
			  ...
			  <form class="form-group" name="newTransForm" method="post">
			    <tr class="" id="addTransItem_<?php echo $count?>">
                  <td><select class="form-control" name="trans_operation_<?php echo $count?>">
						<option value="1">Buy</option>
						<option value="0">Sell</option>
					  </select></td>
                  <td><input class="form-control" type="text" list="json-datalist" id="symbol" placeholder = "e.g. IBM" name="trans_symbol_<?php echo $count?>"></input></td>
                  <datalist id="json-datalist"></datalist>
                  <td><input class="form-control"  type="date" name="trans_operation_<?php echo $count?>"></input></td>
                  <td><input class="form-control" type="number" name="trans_date_<?php echo $count?>"></input></td>
                  <?php 
		            echo "<input class=\"hidden\" id=\"$pflo_id\">";
		          ?>
...
<?php 
	while($count < 12){
		...
		echo "</select></td>";
		echo "<td><input class=\"form-control\" type=\"text\" name=\"trans_symbol_$count\"></input></td>";
		echo "<td><input class=\"form-control\"  type=\"date\" name=\"trans_operation_$count\"></input></td>";
		echo "<td><input class=\"form-control\" type=\"number\" name=\"trans_date_$count\"></input></td>";
		echo "<td><button type=\"submit\" class=\"btn-sm\" onClick=\"return delTransItem($count)\">DEL</button></td>";
		echo "</tr>";
		$count++;
	}
?>
<tr><td colspan="4"><button type="submit" class="btn btn-success" onClick="return delTransItem(<?php echo $count; $count++; ?>)">Save All</button></td></tr>
